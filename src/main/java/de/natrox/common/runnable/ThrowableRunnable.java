...
/**
 * The {@code ThrowableRunnable} interface should be implemented by any
 ...
 * {@code ThrowableRunnable} is implemented by class {@code Thread}.
 * Being active simply means that a thread has been started and has not
 * yet been stopped.
 * <p>
 * In addition, {@code ThrowableRunnable} provides the means for a class to be
 * active while not subclassing {@code Thread}. A class that implements
 * {@code ThrowableRunnable} can run without subclassing {@code Thread}
 * by instantiating a {@code Thread} instance and passing itself in
 * as the target.  In most cases, the {@code ThrowableRunnable} interface should
...
public interface ThrowableRunnable<T extends Throwable> {
    ...
    /**
     * When an object implementing interface {@code ThrowableRunnable} is used
