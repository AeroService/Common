...
public interface ThrowableFunction<T, R, U extends Throwable> {
    ...
    /**
     * Returns a composed {@code ThrowableFunction} that first applies the {@code before}
    ...
    /**
     * Returns a composed {@code ThrowableFunction} that first applies this function to
