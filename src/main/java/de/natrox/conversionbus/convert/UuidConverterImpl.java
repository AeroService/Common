...
final class UuidConverterImpl implements Converter<Object, UUID> {

    private static final char DASH = '-';

    @Override
    public @NotNull UUID read(@NotNull Object obj) throws SerializeException {
        ...
        try {
            ...
            throw new ConversionFailedException(obj, "UUID");
        }
    }
}
