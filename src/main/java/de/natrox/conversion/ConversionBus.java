...
public sealed interface ConversionBus permits ConversionBusImpl {
    ...
    default <T, U> @NotNull Converter<T, U> get(@NotNull TypeToken<T> inputTypeToken, @NotNull TypeToken<U> outputTypeToken) {
    ...
    interface Builder extends IBuilder<ConversionBus> {
        ...
        ConversionBus.@NotNull Builder registerProvider(@NotNull BiPredicate<Type, Type> test, @NotNull BiFunction<Type, Type, Converter<?, ?>> function);

        default <T, U> ConversionBus.@NotNull Builder registerProvider(@NotNull Class<? super U> type, @NotNull BiFunction<Type, Type, Converter<? super T, ? super U>> parser) {
            Check.notNull(type, "type");
            Check.notNull(parser, "parser");
            return this.registerProvider((input, output) -> this.testType(output, type), parser::apply);
        }

        default <T, U> ConversionBus.@NotNull Builder registerProvider(@NotNull TypeToken<? super U> typeToken, @NotNull BiFunction<Type, Type, Converter<? super T, ? super U>> parser) {
        ...
        default <T, U> ConversionBus.@NotNull Builder register(@NotNull BiPredicate<Type, Type> test, @NotNull Converter<T, U> converter) {
            Check.notNull(test, "test");
            Check.notNull(converter, "parser");
            return this.registerProvider(test, (input, output) -> converter);
        }

        default <T, U> ConversionBus.@NotNull Builder register(@NotNull Class<? super U> type, @NotNull Converter<T, U> converter) {
            Check.notNull(type, "type");
            Check.notNull(converter, "parser");
            return this.registerProvider((input, output) -> this.testType(output, type), (input, output) -> converter);
        }

        default <T, U> ConversionBus.@NotNull Builder register(@NotNull Class<? super T> in, @NotNull Class<? super U> out, @NotNull Converter<T, U> converter) {
            Check.notNull(in, "type");
            Check.notNull(out, "type");
            Check.notNull(converter, "parser");
            return this.registerProvider((input, output) -> this.testType(output, out) && this.testType(input, in), (input, output) -> converter);
        }

        default <T, U> ConversionBus.@NotNull Builder register(@NotNull TypeToken<? super U> typeToken, @NotNull Converter<T, U> converter) {
            Check.notNull(typeToken, "typeToken");
            Check.notNull(converter, "parser");
            return this.registerProvider((input, output) -> this.testType(output, typeToken.getType()), (input, output) -> converter);
        }

        default <T, U> ConversionBus.@NotNull Builder registerExactProvider(@NotNull Class<U> type, @NotNull BiFunction<Type, Type, Converter<T, U>> parser) {
            Check.notNull(type, "type");
            Check.notNull(parser, "parser");
            return this.registerProvider((input, output) -> output.equals(type), parser::apply);
        }

        default <T, U> ConversionBus.@NotNull Builder registerExactProvider(@NotNull TypeToken<U> typeToken, @NotNull BiFunction<Type, Type, Converter<T, U>> parser) {
            Check.notNull(typeToken, "typeToken");
            Check.notNull(parser, "parser");
            return this.registerProvider((input, output) -> output.equals(typeToken.getType()), parser::apply);
        }

        default <T, U> ConversionBus.@NotNull Builder registerExact(@NotNull Class<U> type, @NotNull Converter<T, U> converter) {
            Check.notNull(type, "type");
            Check.notNull(converter, "parser");
            return this.register((input, output) -> output.equals(type), converter);
        }

        default <T, U> ConversionBus.@NotNull Builder registerExact(@NotNull Class<T> in, @NotNull Class<U> out, @NotNull Converter<? super T, ? super U> converter) {
            Check.notNull(in, "type");
        ...
        default <T, U> ConversionBus.@NotNull Builder registerExact(@NotNull TypeToken<U> typeToken, @NotNull Converter<T, U> converter) {
            Check.notNull(typeToken, "typeToken");
            Check.notNull(converter, "parser");
            return this.register((input, output) -> output.equals(typeToken.getType()), converter);
        }

        default <T, U> ConversionBus.@NotNull Builder registerExact(@NotNull TypeToken<T> in, @NotNull TypeToken<U> out, @NotNull Converter<T, U> converter) {
            Check.notNull(in, "typeToken");
            Check.notNull(out, "typeToken");
            Check.notNull(converter, "parser");
            return this.register((input, output) -> output.equals(out.getType()) && input.equals(in.getType()), converter);
        }
