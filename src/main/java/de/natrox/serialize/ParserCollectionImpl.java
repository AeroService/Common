...
final class ParserCollectionImpl implements ParserCollection {
    ...
    static {
        DEFAULT = ParserCollection
            ...
            .registerExactProvider(double[].class, type ->  ArrayParser.createDouble())
            .registerExactProvider(float[].class, type ->  ArrayParser.createFloat())
            .registerExactProvider(int[].class, type ->  ArrayParser.createInteger())
            .registerExactProvider(long[].class, type ->  ArrayParser.createLong())
            .registerExactProvider(short[].class, type ->  ArrayParser.createShort())
