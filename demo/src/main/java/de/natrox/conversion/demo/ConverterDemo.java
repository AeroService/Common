...
package de.natrox.conversion.demo;

import de.natrox.conversion.demo.util.Mood;
import de.natrox.conversion.demo.util.TestObject;
import de.natrox.conversion.exception.SerializeException;
import de.natrox.conversion.convert.Converter;
import de.natrox.conversion.convert.EnumConverter;
import de.natrox.conversion.convert.ListConverter;
import de.natrox.conversion.convert.MapConverter;
import de.natrox.conversion.convert.ObjectConverter;
import de.natrox.conversion.convert.SetConverter;
import de.natrox.conversion.convert.Converters;
